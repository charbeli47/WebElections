<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="useractivity.aspx.cs" Inherits="Web.resources.useractivity" %>
<link href="css/iCheck/all.css" rel="stylesheet" type="text/css" />
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        S Users
                        <small><%=user.FirstName+" "+user.LastName %>'s Activity</small>
                    </h1>
                    <%--<ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box" style="width:95%;margin-left:auto;margin-right:auto;padding:10px">
                                <div class="box-header">
                                     <h3 class="box-title"><div style="width:100px;float:right;margin-bottom:-25px"><a href="resources/downloadExcel.ashx?userId=<%=user.id %>" target="_blank" class="btn btn-primary" style="color:white">Download Excel</a></div><div style="clear:right"></div><br/></h3>
                                </div><!-- /.box-header -->
